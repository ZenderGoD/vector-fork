            ...
            <div className="max-w-lg space-y-12">
                ...
                <div className="grid gap-4">
                  <div className="flex items-start space-x-4 group">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-300">Get started in under 30 seconds</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4 group">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-300">Bank-level encryption for your data</p>
                    </div>
                  </div>
              ...
              <div className="space-y-4 pt-8 border-t border-white/10">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-slate-300 font-medium">5.0 rating</span>
                </div>
                <blockquote className="text-slate-200 italic">
                  "AIKP has transformed how I work. It's like having a brilliant assistant available 24/7."
                </blockquote>
                <cite className="text-sm text-slate-400">— Sarah Chen, Product Manager</cite>
              </div>
            </div>
          </div>
        </div>
